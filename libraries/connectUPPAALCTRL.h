...
extern "C" {
void compute_strategy(double *room_temps, int global_time, int offset, double *envelope_temps, double *floor_temps,
                      int month, int day, double forward_temp, double* Treturn, int reuse, double consumed_power, double *tank_temps, int tank_levels, double mixing);
